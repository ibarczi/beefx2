/* eslint-disable no-debugger, spaced-comment, no-multi-spaces, camelcase */
   
import {Corelib, DOMplusUltra, DragWithDOM, FxUiPars} from '../improxy.js'
...
export const extendUi = ui => {
  ...
  ui.onFactoryToggled = on => {
    ...
    const cats = {
      ...
      filter: {catName: 'Filter', arr: [], cc: '', hue: 70},
      ...
      generator: {catName: 'Generator', arr: [], cc: 'halfup', hue: 45},
      ...
      visual: {catName: 'Visual', arr: [], cc: '', hue: 300},
